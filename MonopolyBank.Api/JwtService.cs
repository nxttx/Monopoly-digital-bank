...
public static class JwtService
{
    ...
    {
        if (string.IsNullOrWhiteSpace(headerAlg) || headerAlg.Equals("none", StringComparison.OrdinalIgnoreCase))
            throw new ArgumentException("Alg cannot be null, empty, whitespace or \"none\".");
